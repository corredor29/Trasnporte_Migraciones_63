...
namespace Migraciones_Trasporte.src.Modules.Type_Load.Infrastructure.Repository;

public class TypeLoadRespository
{
    private readonly AppDbContext _context;

    public TypeLoadRespository(AppDbContext context)
    {
        _context = context;
    }
