    ...
    public partial class AssignmentRole : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    description = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    AssignmentRoleEntityId = table.Column<Guid>(type: "char(64)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_assignment_role", x => x.id);
                    table.ForeignKey(
                        name: "FK_assignment_role_assignment_role_AssignmentRoleEntityId",
                        column: x => x.AssignmentRoleEntityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_assignment_role_AssignmentRoleEntityId",
                table: "assignment_role",
                column: "AssignmentRoleEntityId");
        }
