    ...
    public partial class ReasonDisputes : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    description = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ReasonDisputesEntityId = table.Column<Guid>(type: "char(64)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_reason_disputes", x => x.id);
                    table.ForeignKey(
                        name: "FK_reason_disputes_reason_disputes_ReasonDisputesEntityId",
                        column: x => x.ReasonDisputesEntityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_reason_disputes_ReasonDisputesEntityId",
                table: "reason_disputes",
                column: "ReasonDisputesEntityId");
        }
