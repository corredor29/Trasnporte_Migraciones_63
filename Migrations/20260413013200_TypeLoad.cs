    ...
    public partial class TypeLoad : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    description = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    TypeLoadEntityId = table.Column<Guid>(type: "char(64)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_type_load", x => x.id);
                    table.ForeignKey(
                        name: "FK_type_load_type_load_TypeLoadEntityId",
                        column: x => x.TypeLoadEntityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_type_load_TypeLoadEntityId",
                table: "type_load",
                column: "TypeLoadEntityId");
        }
