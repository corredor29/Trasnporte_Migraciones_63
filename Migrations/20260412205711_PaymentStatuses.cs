        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentStatusesEntityId = table.Column<Guid>(type: "char(64)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_payment_statuses", x => x.id);
                    table.ForeignKey(
                        name: "FK_payment_statuses_payment_statuses_PaymentStatusesEntityId",
                        column: x => x.PaymentStatusesEntityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_payment_statuses_PaymentStatusesEntityId",
                table: "payment_statuses",
                column: "PaymentStatusesEntityId");
        }
