        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentProvidersEntityId = table.Column<Guid>(type: "char(64)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_payment_providers", x => x.id);
                    table.ForeignKey(
                        name: "FK_payment_providers_payment_providers_PaymentProvidersEntityId",
                        column: x => x.PaymentProvidersEntityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_payment_providers_PaymentProvidersEntityId",
                table: "payment_providers",
                column: "PaymentProvidersEntityId");
        }
