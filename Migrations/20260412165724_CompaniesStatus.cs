    ...
    public partial class CompaniesStatus : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    description = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    CompaniesStatusEntityId = table.Column<Guid>(type: "char(64)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_companies_status", x => x.id);
                    table.ForeignKey(
                        name: "FK_companies_status_companies_status_CompaniesStatusEntityId",
                        column: x => x.CompaniesStatusEntityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_companies_status_CompaniesStatusEntityId",
                table: "companies_status",
                column: "CompaniesStatusEntityId");
        }
