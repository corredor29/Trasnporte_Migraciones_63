    ...
    public partial class MessageType : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    description = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    MessageTypeEntityId = table.Column<Guid>(type: "char(64)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_message_type", x => x.id);
                    table.ForeignKey(
                        name: "FK_message_type_message_type_MessageTypeEntityId",
                        column: x => x.MessageTypeEntityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_message_type_MessageTypeEntityId",
                table: "message_type",
                column: "MessageTypeEntityId");
        }
