    ...
    public partial class SubscriptionStatus : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    description = table.Column<string>(type: "varchar(50)", maxLength: 50, nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    SubscriptionStatusEntityId = table.Column<Guid>(type: "char(64)", nullable: true, collation: "ascii_general_ci")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_subscription_status", x => x.id);
                    table.ForeignKey(
                        name: "FK_subscription_status_subscription_status_SubscriptionStatusEn~",
                        column: x => x.SubscriptionStatusEntityId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_subscription_status_SubscriptionStatusEntityId",
                table: "subscription_status",
                column: "SubscriptionStatusEntityId");
        }
